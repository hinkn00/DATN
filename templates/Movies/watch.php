        ...
        <div class="row">
            <div class="col-md-9 col-sm-12 col-xs-12">
                <div class="blog-detail-ct">
                    ...
                    <iframe id="if_video" type="text/html" width="100%" height="500px"
                        src="<?= !empty($episode->link_film) ? $episode->link_film : '' ?>" frameborder="0"
                    ...
                    <div style="color:white;">
                        ...
                        <ul style="display:flex; margin-top:5px">
                            ...
                            <li class="episode"><a class="episode-links"
                                    href="<?= $this->Url->build(['_name' => 'watch_movie', 'slug' => $movie->m_slug, "episode" => $i]) ?>"><?= $i ?></a>
                            </li>
                            <?php endfor; ?>
                        </ul>
                    </div>
                ...
                <div class="sidebar">
                    <div class="sb-recentpost sb-it">
                        ...
                        <div class="recent-item">
                            ...
                            <h6 style="margin-left: 15px;"><a
                                    href="<?php echo $this->Url->build(["_name" => "movies_details", "slug" => $value->m_slug, "id" => $value->id]); ?>"><?= $value->m_name ?></a>
                            </h6>
                        </div>
                        <?php endif; ?>
                        <?php endforeach; ?>
