		...
		<div class="row">
			<div class="col-md-9 col-sm-12 col-xs-12">
				<div class="blog-detail-ct">
                    ...
                    <iframe type="text/html" width="100%" height="500px" src="<?= !empty($movie->episodes[0]['link_film'])?$movie->episodes[0]['link_film']:''?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <h1>
                        Nội dung phim
                    </h1>
